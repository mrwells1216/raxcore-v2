...
const IMAGE_TYPES = [
  { value: 'front_center',        label: 'Front-Center (Full Rack)' },
  { value: 'front_center_left',   label: 'Front-Center-Left (Right Antler)' },
  { value: 'front_center_right',  label: 'Front-Center-Right (Left Antler)' },
  { value: 'front_top_center',    label: 'Front-Top-Center (Full Rack)' },
  { value: 'front_top_left',      label: 'Front-Top-Left (Right Antler)' },
  { value: 'front_top_right',     label: 'Front-Top-Right (Left Antler)' },
  { value: 'front_bottom_center', label: 'Front-Bottom-Center (Full Rack)' },
  { value: 'front_bottom_left',   label: 'Front-Bottom-Left (Right Antler)' },
  { value: 'front_bottom_right',  label: 'Front-Bottom-Right (Left Antler)' },
  { value: '__sep_back__',        label: '' },
  { value: 'back_center',         label: 'Back-Center (Full Rack)' },
  { value: 'back_center_left',    label: 'Back-Center-Left (Right Antler)' },
  { value: 'back_center_right',   label: 'Back-Center-Right (Left Antler)' },
  { value: 'back_top_center',     label: 'Back-Top-Center (Full Rack)' },
  { value: 'back_top_left',       label: 'Back-Top-Left (Right Antler)' },
  { value: 'back_top_right',      label: 'Back-Top-Right (Left Antler)' },
  { value: 'back_bottom_center',  label: 'Back-Bottom-Center (Full Rack)' },
  { value: 'back_bottom_left',    label: 'Back-Bottom-Left (Right Antler)' },
  { value: 'back_bottom_right',   label: 'Back-Bottom-Right (Left Antler)' },
