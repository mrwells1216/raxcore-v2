...
export function toFlatMeasurements(sheet: ScoreSheetMeasurements): Measurements {
  ...
  return {
    inside_spread: sheet.insideSpread ?? undefined,
    main_beam_left: sheet.left.mainBeamLength ?? undefined,
    main_beam_right: sheet.right.mainBeamLength ?? undefined,
    g1_left: getTineLength(sheet.left.tines, 1),
    g1_right: getTineLength(sheet.right.tines, 1),
    g2_left: getTineLength(sheet.left.tines, 2),
    g2_right: getTineLength(sheet.right.tines, 2),
    g3_left: getTineLength(sheet.left.tines, 3),
    g3_right: getTineLength(sheet.right.tines, 3),
    g4_left: getTineLength(sheet.left.tines, 4),
    g4_right: getTineLength(sheet.right.tines, 4),
    g5_left: getTineLength(sheet.left.tines, 5),
    g5_right: getTineLength(sheet.right.tines, 5),
    h1_left: getMassCirc(sheet.left.masses, 1),
    h1_right: getMassCirc(sheet.right.masses, 1),
    h2_left: getMassCirc(sheet.left.masses, 2),
    h2_right: getMassCirc(sheet.right.masses, 2),
    h3_left: getMassCirc(sheet.left.masses, 3),
    h3_right: getMassCirc(sheet.right.masses, 3),
    h4_left: getMassCirc(sheet.left.masses, 4),
    h4_right: getMassCirc(sheet.right.masses, 4),
    abnormal_points: leftAbnormal + rightAbnormal || undefined,
    deductions: sheet.deductions.sideToSideDifferences ?? undefined,
    gross_score: sheet.grossScore ?? undefined,
    net_score: sheet.netScore ?? undefined,
    confidence: sheet.confidence ?? undefined,
  }
}
...
export function fromUIScoreSheet(
  ...
  return {
    ...
    grossScore: sheet.totals.gross_score,
    netScore: sheet.totals.net_score,
  }
}
