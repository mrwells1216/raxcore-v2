-- ============================================================================
-- Calibration Profiles Table (Fixed v2 - no model_versions dependency)
-- ============================================================================
...
DROP POLICY IF EXISTS "calibration_profiles_service_policy" ON calibration_profiles;
CREATE POLICY "calibration_profiles_service_policy"
